...
SECRET_KEY = 'django-insecure-$gb5c6lm%9x^dx*mnt!k^9i_sprr_ldh6+^bwx^r5m4!i60f4@'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'user_app.authenticate.CustomAuthentication',
    ]
}
...
SIMPLE_JWT = {
    'ACCESS_DEAD_LIFETIME': timedelta(days=1),
